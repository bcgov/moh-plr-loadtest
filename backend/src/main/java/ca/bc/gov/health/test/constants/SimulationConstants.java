...
public class SimulationConstants {
    ...
    public static String PLR_DB_URL = "PLR_DB_URL";
    public static String PLR_DB_USER = "PLR_DB_USER";
    public static String PLR_DB_PASSWORD = "PLR_DB_PW";

    public static String PLR_API_HOST_URL = "PLR_API_HOST_URL";
    public static String PLR_HEADER_API_HOST = "PLR_HEADER_API_HOST";
